...
function Register() {
  ...
  const handleValidation = () => {
    ...
    if (password !== confirmPassword) {
      toast.error("Unmatch password and confirm password", toastOptions);
      return false;
      ...
      toast.error(
        "Password too short, hacker may love you. (at least 5 characters)",
        toastOptions
      );
      return false;
    } else if (email === "") {
      toast.error("Email missing", toastOptions);
      return false;
    }
    return true;
  };
    ...
    <>
      <FormContainer>
        <form onSubmit={(event) => handleSubmit(event)}>
          ...
          <span>
            Already a member of us? <Link to="/login">Lets chat now!</Link>
          </span>
        </form>
      </FormContainer>
